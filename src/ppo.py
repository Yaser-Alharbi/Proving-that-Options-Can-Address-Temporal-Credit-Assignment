# based on https://docs.cleanrl.dev/rl-algorithms/ppo/#ppopy
import csv
import os
import pathlib
import random
...
if __name__ == "__main__":
    ...
    parts = [args.env_id, condition, f"seed{args.seed}", time.strftime("%m-%d_%H-%M")]
    if args.tag:
    ...
    run_dir = pathlib.Path("results") / run_name
    ...
    csv_writer.writerow(["decision_step", "primitive_step", "episodic_return", "episodic_length"])
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            if "primitive_steps" in infos:
                primitive_step += int(infos["primitive_steps"][infos["_primitive_steps"]].sum())
            else:
            ...
            if "raw_return" in infos:
                ...
                for r, l in zip(infos["raw_return"][mask], infos["primitive_length"][mask]):
                    ...
                    csv_writer.writerow([global_step, primitive_step, r, l])
                    csv_file.flush()
